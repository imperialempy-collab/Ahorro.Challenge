...
export const ElementosFinancieros = {
    // 1. TENTACIONES (Dan felicidad, restan plata. Podés esquivarlas)
    tentaciones: [
        { id: "cafe", nombre: "Café de Estación", emoji: "☕", costo: 25000, felicidad: 5, tipo: "gasto" },
        { id: "lomito", nombre: "Lomito de Viernes", emoji: "🍔", costo: 50000, felicidad: 10, tipo: "gasto" },
        { id: "zapatillas", nombre: "Zapatillas en Oferta", emoji: "👟", costo: 300000, felicidad: 20, tipo: "gasto" },
        { id: "salida", nombre: "Salida con Amigos", emoji: "🍻", costo: 150000, felicidad: 15, tipo: "gasto" }
    ],

    // 2. MANTENIMIENTO (Si los esquivás mucho, explota la bomba)
    mantenimiento: [
    ...
    // 3. LAS BOMBAS (Castigos por tacaño. Se disparan solas, no caen)
    bombas: {
        salud: { nombre: "Internación Médica", emoji: "🚑", costo: 1500000, msj: "Te hiciste el vivo no comiendo. Internado por anemia." },
        auto: { nombre: "Motor Fundido", emoji: "💥", costo: 1500000, msj: "Por ahorrar aceite, fundiste el motor. Llorá." },
    ...
    // 4. INGRESOS EXTRAS (Oxígeno)
    ingresos: [
        { id: "changa", nombre: "Trabajo Extra", emoji: "💼", costo: -150000, felicidad: -10, tipo: "ingreso" }, // Trabajar extra te saca felicidad
    ...
    instrumentos: [
        ...
        { id: "bingo", nombre: "Bingo Clandestino", emoji: "🎰", costo: 50000, prob: 0.10, premio: 500000, tipo: "apuesta" },
        { id: "chanchito", nombre: "Ahorro Blindado", emoji: "🐷", porcentaje: 0.20, tipo: "salvavidas" }
    ],
    
    // 6. DECISIONES BINARIAS (Aparecen juntas bloqueando la calle)
    decisiones: [
        {
            tipo: "decision", id: "netflix",
            opcionA: { emoji: "📺", nombre: "Netflix", costo: 50000, felicidad: 10, msj: "Netflix!" },
            opcionB: { emoji: "✂️", nombre: "Cancelar", costo: 0, felicidad: -10, msj: "Aborrido pero rico" }
        },
        {
            tipo: "decision", id: "transporte",
            opcionA: { emoji: "🚖", nombre: "Ir en Bolt", costo: 35000, felicidad: 5, msj: "Viaje VIP" },
            opcionB: { emoji: "🚌", nombre: "Ir en Bus", costo: 5000, felicidad: -15, msj: "Calor y sudor" }
        }
    ]
};
