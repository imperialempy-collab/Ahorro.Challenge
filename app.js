...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (localEmail && localStatus) {
        ...
        // AL ESTAR DEFINIDA ARRIBA, ACÁ FUNCIONA PERFECTO.
        window.initApp(); 
    } else {
...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        // Inyecta el email en el Menú Maestro
        ...
        try {
            ...
            if (!docSnap.exists()) {
                ...
                if(!localStorage.getItem('local_user_status')) location.reload();
            } else {
                ...
                // Actualiza visualmente el Menú Maestro
                ...
                // Si la memoria estaba vacía (login inicial), activamos
        ...
        } catch (error) { console.error("Control en las sombras falló. Usando memoria local."); }
    } else { 
